...
export const fxInterfaces: ApiInterface[] = [
  ...
  },
  {
    ...
    "targetUrl": "https://biz.finance.sina.com.cn/forex/forex.php?startdate=2012-01-01&enddate=2021-06-14&money_code=EUR&type=0",
    ...
    "inputParameters": [
      {
        ...
        "name": "symbol",
        "type": "str",
        "description": "symbol=\"美元\"; choice of {'美元', '英镑', '欧元', '澳门元', '泰国铢', '菲律宾比索', '港币', '瑞士法郎', '新加坡元', '瑞典克朗', '丹麦克朗', '挪威克朗', '日元', '加拿大元', '澳大利亚元', '新西兰元', '韩国元'}",
        "defaultValue": "美元",
        "choices": [
          "美元",
          "英镑",
    ...
    "inputParameters": [
      {
        ...
        "name": "symbol",
        "type": "str",
        "description": "symbol=\"人民币\"; 此处提供中文的币种名称, 可以访问[网页](https://cn.investing.com/currencies/cny-jmd) 的页面下方查看",
        "defaultValue": "人民币",
        "isRequired": false
      }
    ],
