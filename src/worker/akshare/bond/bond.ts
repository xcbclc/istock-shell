...
export const bondInterfaces: ApiInterface[] = [
  ...
  },
  {
    ...
    remarks:
      '单次返回指定可转债、指定频率、复权调整和时间区间的分时数据, 其中 1 分钟数据只返回近 1 个交易日数据且不复权; 其余 period 只能获取近期的数据',
    inputParameters: [
      {
        title: 'symbol',
        name: 'symbol',
      ...
      },
      {
        ...
        type: 'str',
        description:
          "adjust=''; choice of {'', 'qfq', 'hfq'}; '': 不复权, 'qfq': 前复权, 'hfq': 后复权, 其中 1 分钟数据返回近 1 个交易日数据且不复权",
        defaultValue: '',
        choices: ['', 'qfq', 'hfq'],
        isRequired: false,
      },
  ...
  },
  {
    ...
    inputParameters: [
      ...
      },
      {
        ...
        type: 'str',
        description:
          'indicator="基本信息"; choice of {"基本信息", "中签号", "筹资用途", "重要日期"}, 其中 "可转债重要条款" 在 "基本信息中"',
        defaultValue: '基本信息',
        choices: ['基本信息', '中签号', '筹资用途', '重要日期'],
        isRequired: false,
      },
    ],
    outputParameters: [
