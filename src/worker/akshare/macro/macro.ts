...
export const macroInterfaces: ApiInterface[] = [
  ...
  },
  {
    ...
    inputParameters: [
      ...
      },
      {
        ...
        type: 'str',
        description:
          '数据路径， 需与kind参数匹配，具体见官网，多层级之间使用 > 连接 。<br> 示例：<br> 国民经济核算 > 支出法国内生产总值<br> 人口 > 总人口<br> 金融业 > 保险系统机构、人员数 > 保险系统机构数',
        isRequired: true,
      },
      {
        title: 'period',
        ...
        type: 'str',
        description:
          '时间区间 <br/>参考格式如下(英文逗号分割，且不能有多余空格)：<br/> 月：201201,201205<br/> 季：2012A,2012B,2012C,2012D<br/> 年：2012,2013 <br> 至今：2013-<br> 最近：last10',
        isRequired: true,
      },
    ],
    outputParameters: [],
  },
  {
    ...
    targetUrl: 'https://data.stats.gov.cn/easyquery.htm',
    description:
      '国家统计局地区数据通用接口，包括分省月度数据、分省季度数据、分省年度数据、主要城市月度价格、主要城市年度数据、港澳台月度数据、港澳台年度数据，具体指标见数据官网。',
    remarks: '根据参数返回指定数据',
    inputParameters: [
      {
        title: 'kind',
        ...
        type: 'str',
        description:
          '数据类别，包括：分省月度数据、分省季度数据、分省年度数据、主要城市月度价格、主要城市年度数据、港澳台月度数据、港澳台年度数据。',
        isRequired: true,
      },
      {
        title: 'path',
        ...
        type: 'str',
        description:
          '数据路径， 需与kind匹配，具体见官网，多层级之间使用 > 连接 。<br> 示例：<br> 国民经济核算 > 地区生产总值<br> 财政 > 地方财政收入',
        isRequired: true,
      },
      {
        title: 'indicator',
        ...
        type: 'Union[str, None]',
        description:
          '指定指标，表示在当前path下可选择的指标。在指定region参数的情况下，此参数可以设置为None，此时将获取指定地区下所有可选指标的值。indicator和region参数不能同时为None。',
        isRequired: false,
      },
      {
        title: 'region',
