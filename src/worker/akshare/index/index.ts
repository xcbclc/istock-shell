...
export const indexInterfaces: ApiInterface[] = [
    ...
    inputParameters: [
      {
        ...
        defaultValue: '上证系列指数',
        choices: ['沪深重要指数', '上证系列指数', '深证系列指数', '指数成份', '中证系列指数'],
        isRequired: false,
      },
    ],
    outputParameters: [
  ...
  },
  {
    ...
    inputParameters: [
      ...
      },
      {
        ...
        type: 'str',
        description:
          "period=\"1\"; choice of {'1', '5', '15', '30', '60'}, 其中 1 分钟数据只能返回当前的, 其余只能返回近期的数据",
        defaultValue: '1',
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          "symbol=\"柯桥时尚指数\"; choice of {'柯桥时尚指数', '时尚创意指数', '时尚设计人才数', '新花型推出数', '创意产品成交数', '创意企业数量', '时尚活跃度指数', '电商运行数', '时尚平台拓展数', '新产品销售额占比', '企业合作占比', '品牌传播费用', '时尚推广度指数', '国际交流合作次数', '企业参展次数', '外商驻点数量变化', '时尚评价指数'}",
        defaultValue: '柯桥时尚指数',
        choices: [
          '柯桥时尚指数',
          '时尚创意指数',
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'symbol="composite"; choice of {"composite", "shanghai-rotterdam", "rotterdam-shanghai", "shanghai-los angeles", "los angeles-shanghai", "shanghai-genoa", "new york-rotterdam", "rotterdam-new york"}',
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'symbol="市场表征"; choice of {"市场表征", "一级行业", "二级行业", "风格指数", "大类风格指数", "金创指数"}',
        defaultValue: '市场表征',
        choices: ['市场表征', '一级行业', '二级行业', '风格指数', '大类风格指数', '金创指数'],
        isRequired: false,
      },
    ],
    outputParameters: [
  ...
  },
  {
    ...
    api: 'index_hist_sw',
    targetUrl:
      'https://www.swsresearch.com//institute_sw/allIndex/releasedIndex/releasedetail?code=801002&name=申万中小',
  ...
  },
  {
    ...
    api: 'index_min_sw',
    targetUrl:
      'https://www.swsresearch.com//institute_sw/allIndex/releasedIndex/releasedetail?code=801001&name=申万中小',
