    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'symbol="狭义乘用车-单月"; choice of {"狭义乘用车-单月", "狭义乘用车-累计", "广义乘用车-单月", "广义乘用车-累计"}',
        defaultValue: '狭义乘用车-单月',
        choices: ['狭义乘用车-单月', '狭义乘用车-累计', '广义乘用车-单月', '广义乘用车-累计'],
        isRequired: false,
      },
      {
        title: 'indicator',
    ...
    inputParameters: [
      {
        ...
        defaultValue: '整体市场',
        choices: ['整体市场', '销量占比-PHEV-BEV', '销量占比-ICE-NEV'],
        isRequired: false,
      },
    ],
    outputParameters: [
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'date=""; "": 当前时刻空气质量排名, 默认; "20200312": 当日空气质量排名; "202003": 当月空气质量排名; "2019": 当年空气质量排名;',
        defaultValue: '',
        isRequired: false,
      },
    ],
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'indicator="胡润百富榜"; choice of {"胡润百富榜", "胡润全球富豪榜", "胡润印度榜", "胡润全球独角兽榜", "全球瞪羚企业榜", "胡润Under30s创业领袖榜", "胡润世界500强", "胡润艺术榜"}',
        defaultValue: '胡润百富榜',
        choices: [
          '胡润百富榜',
          '胡润全球富豪榜',
      ...
      },
      {
        ...
        type: 'str',
        description:
          'year="2020"; choice of {"胡润百富榜": "2014-至今", "胡润全球富豪榜": "2019-至今", "胡润印度榜": "2018-至今", "胡润全球独角兽榜": "2019-至今", "全球瞪羚企业榜": "2021-至今", "胡润Under30s创业领袖榜": "2019-至今", "胡润世界500强": "2020-至今", "胡润艺术榜": "2019-至今"}',
        defaultValue: '2020',
        choices: [
          '胡润百富榜: 2014-至今',
          '胡润全球富豪榜: 2019-至今',
  ...
  },
  {
    ...
    outputParameters: [
      ...
      },
      {
        ...
        type: 'float64',
        description:
          '商业价值由专业度，关注度，预测热度加权汇总计算后得出，分值范围0~100，综合反映明星作品、代言表现、近期热度及舆情口碑。',
        unit: '',
      },
      {
        title: '专业热度',
        ...
        type: 'float64',
        description:
          '艺人专业热度主要表现艺人历史作品及品牌代言的效果情况，参与计算的指标维度包括历史主演电影票房表现，历史主演视频节目播映热度，电影作品豆瓣评分，作品相关微博内容评论正负向，历史代言品牌数量，品牌热度，艺人获奖数量。',
        unit: '',
      },
      {
        title: '关注热度',
        ...
        type: 'float64',
        description:
          '艺人关注热度主要表现艺人网络中的舆情声量，参与计算的指标维度包括百度搜索指数，百度新闻数量，今日头条新闻数，微博转发量，微博评论量，微博点赞量，微博粉丝数量，贴吧关注数量，微博话题数量。',
        unit: '',
      },
      {
        title: '预测热度',
      ...
      },
      {
        ...
        type: 'float64',
        description:
          '根据艺人近三年参演电影、视频作品在豆瓣等平台的评分、微博正向评价，以及微博好评率等指标综合加权得出。',
        unit: '',
      },
      {
        title: '统计日期',
  ...
  },
  {
    ...
    outputParameters: [
      ...
      },
      {
        ...
        type: 'float64',
        description:
          '流量价值由专业度，关注度，预测热度，带货力加权汇总计算后得出，分值范围0~100，在商业价值的基础上增加了明星近期热度及带货力的权重。',
        unit: '',
      },
      {
        title: '专业热度',
