...
export const futuresInterfaces: ApiInterface[] = [
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          "symbol='豆一'; 交易所对应的具体品种中文名称或者英文代码; 如：大连商品交易所的豆一; 具体品种查询：https://www.99qh.com/data/stockIn?productId=61",
        defaultValue: '豆一',
        isRequired: false,
      },
    ],
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'date="20200511"; 指定交易日, 该数据接口可以获取从 2000 年开始的数据, 20160104 由于交易所数据问题，返回为空可以调用 **futures_dce_position_rank_other** 来返回数据',
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'symbol="IF2008"; 具体合约(期货品种符号需要大写), 可以通过调用 ak.match_main_contract(symbol="cffex") 接口获取, 或者访问网页获取',
        defaultValue: 'IF2008',
        isRequired: false,
      },
      {
        ...
        type: 'str',
        description:
          'period="1"; choice of {"1": "1分钟", "5": "5分钟", "15": "15分钟", "30": "30分钟", "60": "60分钟"}',
        defaultValue: '1',
        choices: ['1: 1分钟', '5: 5分钟', '15: 15分钟', '30: 30分钟', '60: 60分钟'],
        isRequired: false,
      },
    ],
    outputParameters: [
  ...
  },
  {
    ...
    inputParameters: [
      ...
      },
      {
        ...
        defaultValue: 'DCE',
        choices: ['CFFEX', 'INE', 'CZCE', 'DCE', 'SHFE', 'GFEX'],
        isRequired: false,
      },
    ],
    outputParameters: [
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'symbol="HG00Y"; 品种代码；可以通过 ak.futures_global_spot_em() 来获取所有可获取历史行情数据的品种代码',
        defaultValue: 'HG00Y',
        isRequired: false,
      },
    ],
  ...
  },
  {
    ...
    remarks:
      '单次获取指定交易日前一日的所有期货品种的结算价数据; 只能获取过去 60 个交易日内的数据; 由于国内网络限制, 请使用代理访问',
    inputParameters: [
      {
        title: 'date',
        name: 'date',
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'symbol="中证监控油脂油料期货指数"; choice of {"中证商品期货指数", "中证商品期货价格指数", "中证监控油脂油料期货指数", "中证监控软商品期货指数", "中证监控能化期货指数", "中证监控钢铁期货指数"}',
    ...
    inputParameters: [
      {
        ...
        defaultValue: '能源',
        choices: ['能源', '化工', '塑料', '纺织', '有色', '钢铁', '建材', '农副'],
        isRequired: false,
      },
    ],
    outputParameters: [
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'symbol="全部"; choice of {"全部", "要闻", "VIP", "财经", "铜", "铝", "铅", "锌", "镍", "锡", "贵金属", "小金属"}',
        defaultValue: '全部',
        choices: ['全部', '要闻', 'VIP', '财经', '铜', '铝', '铅', '锌', '镍', '锡', '贵金属', '小金属'],
        isRequired: false,
      },
    ],
    outputParameters: [
