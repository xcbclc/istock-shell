    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'symbol="ho2303P2350"; 具体合约代码(包括看涨和看跌标识), 可以通过 ak.option_cffex_sz50_spot_sina 中的 call-标识 获取',
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'symbol="io2202P4350"; 具体合约代码(包括看涨和看跌标识), 可以通过 ak.option_cffex_hs300_spot_sina 中的 call-标识 获取',
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          'symbol="mo2208P6200"; 具体合约代码(包括看涨和看跌标识), 可以通过 ak.option_cffex_zz1000_spot_sina 中的 call-标识 获取',
  ...
  },
  {
    ...
    inputParameters: [
      ...
      },
      {
        ...
        type: 'str',
        description:
          'indicator="期权交易情况-认沽交易量"; choice of {"期权交易情况-认沽交易量","期权持仓情况-认沽持仓量", "期权交易情况-认购交易量", "期权持仓情况-认购持仓量"}',
  ...
  },
  {
    ...
    outputParameters: [
      ...
      },
      {
        ...
        type: 'float64',
        description:
          '注意: 指在期权剩余有效期内，合约标的价格变动有利于期权权利方的可能性。时间价值和内在价值共同构成期权的总价值。',
        unit: '',
      },
      {
        title: '内在价值',
        ...
        type: 'float64',
        description:
          '注意: 指假如期权立即履行时该期权的价值，只能为正数或者为零。内在价值与时间价值共同构成期权的总价值。',
        unit: '',
      },
      {
        title: '隐含波动率',
      ...
      },
      {
        ...
        type: 'float64',
        description:
          '注意: 指一种衡量股票价格变化剧烈程度的指标，一般用百分数表示。股价波动率与认购期权、认沽期权价值均为正相关关系。',
        unit: '',
      },
      {
        title: '到期日',
  ...
  },
  {
    ...
    outputParameters: [
      ...
      },
      {
        ...
        type: 'float64',
        description:
          '注意: 实际杠杆比率=对冲值×杠杆比率，透过实际杠杆比率，投资者可知道当标的涨跌1%时，期权的理论价格会变动多少个百分点。',
        unit: '',
      },
      {
        title: 'Delta',
        ...
        type: 'float64',
        description:
          '注意: 指期权标的股票价格变化对期权价格的影响程度。Delta=期权价格变化/期权标的股票价格变化。股票价格与认购期权价值为正相关关系，与认沽期权价值为负相关关系。',
        unit: '',
      },
      {
        title: 'Gamma',
      ...
      },
      {
        ...
        type: 'float64',
        description:
          '注意: 指合约标的证券价格波动率变化对期权价值的影响程度。Vega=期权价值变化/波动率的变化。波动率与认购、认沽期权价值均为正相关关系。',
        unit: '',
      },
      {
        title: 'Rho',
        ...
        type: 'float64',
        description:
          '注意: 指无风险利率变化对期权价格的影响程度。Rho=期权价格的变化／无风险利率的变化。市场无风险利率与认购期权价值为正相关，与认沽期权为负相关。',
        unit: '',
      },
      {
        title: 'Theta',
        ...
        type: 'float64',
        description:
          '注意: 指到期时间变化对期权价值的影响程度。Theta=期权价值变化/到期时间变化。到期期限与认购、认沽期权价值均为正相关关系。',
        unit: '',
      },
      {
        title: '到期日',
  ...
  },
  {
    ...
    outputParameters: [
      ...
      },
      {
        ...
        type: 'float64',
        description:
          '注意: 折溢价反映的是投资者以现价买入某期权并持有至到期时，标的需要上升或下跌多少才能使这笔投资保本。',
        unit: '',
      },
      {
        title: '标的名称',
    ...
    inputParameters: [
      {
        ...
        type: 'str',
        description:
          "symbol=\"铜期权\"; choice of {'原油期权', '铜期权', '铝期权', '锌期权', '铅期权', '螺纹钢期权', '镍期权', '锡期权', '氧化铝期权', '黄金期权', '白银期权', '丁二烯橡胶期权', '天胶期权'}",
        defaultValue: '铜期权',
        choices: [
          '原油期权',
          '铜期权',
  ...
  },
  {
    ...
    inputParameters: [
      ...
      },
      {
        ...
        type: 'str',
        description:
          'symbol="SR"; choice of {"白糖": "SR", "棉花": "CF", "PTA": "TA", "甲醇": "MA", "菜籽粕": "RM", "动力煤": "ZC", "菜籽油": "OI", "花生": "PK", "对二甲苯": "PX", "烧碱": "SH", "纯碱": "SA", "短纤": "PF", "锰硅": "SM", "硅铁": "SF", "尿素": "UR", "苹果": "AP", "红枣": "CJ", "玻璃": "FG", "瓶片": "PR"}',
        defaultValue: 'SR',
        choices: [
          '白糖: SR',
          '棉花: CF',
