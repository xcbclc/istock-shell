...
keywords: [Empty空状态组件, 空状态展示, Svelte空状态, 数据占位组件, 无数据展示, UI组件库, 前端组件, Web组件, 用户界面, UX设计, 响应式空状态, 状态反馈]
aside: false
editLink: false
outline: [2, 4]
---
...
<IStockShellUiExample src="./example/EmptyDefault.svelte" layout="auto"></IStockShellUiExample>
<IStockShellUiExample src="./example/EmptyCustomize.svelte" layout="auto"></IStockShellUiExample>
