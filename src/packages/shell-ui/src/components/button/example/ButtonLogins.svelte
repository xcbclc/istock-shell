...
<div class="flex items-center justify-center">
  <div class="grid gap-4 max-w-60">
    <!-- Email -->
    <Button class="bg-white text-black border-[#e5e5e5]">
    ...
    <!-- GitHub -->
    <Button class="bg-black text-white border-black">
    ...
    <!-- Facebook -->
    <Button class="facebook bg-[#1A77F2] text-white border-[#005fd8]">
    ...
    <!-- Kakao -->
    <Button class="bg-[#FEE502] text-[#181600] border-[#f1d800]">
    ...
    <!-- Amazon -->
    <Button class="bg-[#FF9900] text-black border-[#e17d00]">
    ...
    <!-- Microsoft -->
    <Button class="bg-[#2F2F2F] text-white border-black">
    ...
    <!-- Line -->
    <Button class="bg-[#03C755] text-white border-[#00b544]">
    ...
    <!-- Slack -->
    <Button class="bg-[#622069] text-white border-[#591660]">
    ...
    <!-- LinkedIn -->
    <Button class="bg-[#0967C2] text-white border-[#0059b3]">
    ...
    <!-- VK -->
    <Button class="bg-[#47698F] text-white border-[#35567b]">
    ...
    <!-- WeChat -->
    <Button class="bg-[#5EBB2B] text-white border-[#4eaa0c]">
