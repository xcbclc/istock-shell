  ...
  <div class="grid gap-4 max-w-60">
    ...
    <ShButton class="bg-[#2F2F2F] text-white border-black">
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
        ><path d="M96 96H247V247H96" fill="#f24f23"></path><path
          d="M265 96V247H416V96"
          fill="#7eba03"
        ></path><path d="M96 265H247V416H96" fill="#3ca4ef"></path><path
          d="M265 265H416V416H265"
          fill="#f9ba00"
        ></path></svg
      >
    ...
    <ShButton class="bg-[#622069] text-white border-[#591660]">
      <svg
        ...
        ><g stroke-linecap="round" stroke-width="78"
          ><path stroke="#36c5f0" d="m110 207h97m0-97h.1v-.1"></path><path
            stroke="#2eb67d"
