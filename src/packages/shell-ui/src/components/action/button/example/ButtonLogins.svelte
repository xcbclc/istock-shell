...
<div class="flex items-center justify-center">
  <div class="grid gap-4 max-w-60">
    <!-- Email -->
    <ShButton class="bg-white text-black border-[#e5e5e5]">
    ...
    <!-- GitHub -->
    <ShButton class="bg-black text-white border-black">
    ...
    <!-- Facebook -->
    <ShButton class="facebook bg-[#1A77F2] text-white border-[#005fd8]">
      <svg aria-label="Facebook logo" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
        ><path fill="white" d="M8 12h5V8c0-6 4-7 11-6v5c-4 0-5 0-5 3v2h5l-1 6h-4v12h-6V18H8z"></path></svg
      >
      Login with Facebook
    </ShButton>
    ...
    <!-- Kakao -->
    <ShButton class="bg-[#FEE502] text-[#181600] border-[#f1d800]">
    ...
    <!-- Amazon -->
    <ShButton class="bg-[#FF9900] text-black border-[#e17d00]">
      <svg aria-label="Amazon logo" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
        ><g fill="black"
          ><path
    ...
    <!-- Microsoft -->
    <ShButton class="bg-[#2F2F2F] text-white border-black">
      <svg aria-label="Microsoft logo" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
        ><path d="M96 96H247V247H96" fill="#f24f23"></path><path d="M265 96V247H416V96" fill="#7eba03"></path><path
          d="M96 265H247V416H96"
          fill="#3ca4ef"
        ></path><path d="M265 265H416V416H265" fill="#f9ba00"></path></svg
      >
      Login with Microsoft
    </ShButton>

    <!-- Line -->
    <ShButton class="bg-[#03C755] text-white border-[#00b544]">
    ...
    <!-- Slack -->
    <ShButton class="bg-[#622069] text-white border-[#591660]">
      <svg aria-label="Slack logo" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
        ><g stroke-linecap="round" stroke-width="78"
          ><path stroke="#36c5f0" d="m110 207h97m0-97h.1v-.1"></path><path stroke="#2eb67d" d="m305 110v97m97 0v.1h.1"
          ></path><path stroke="#ecb22e" d="m402 305h-97m0 97h-.1v.1"></path><path
            stroke="#e01e5a"
    ...
    <!-- LinkedIn -->
    <ShButton class="bg-[#0967C2] text-white border-[#0059b3]">
    ...
    <!-- VK -->
    <ShButton class="bg-[#47698F] text-white border-[#35567b]">
      <svg aria-label="VK logo" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2240 2240"
        ><g fill="white"
          ><path
    ...
    <!-- WeChat -->
    <ShButton class="bg-[#5EBB2B] text-white border-[#4eaa0c]">
    ...
    <ShButton class="bg-white text-black border-[#e5e5e5]">
      <svg
        ...
        /><path
          ...
          class="c"
        /><path d="m213.17 314.54-56.05-16.5 39.55-18.09zM294.46 314.54l16.5-34.59 39.75 18.09z" class="d" /><path
        ...
        /><path
          ...
          style="stroke-linecap:round;stroke-linejoin:round;fill:#c0ad9e;stroke:#c0ad9e"
        /><path
