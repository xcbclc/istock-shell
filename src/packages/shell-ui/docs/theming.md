...
```css
/* 按钮尺寸 */
.btn-xs { @apply h-6 px-2 text-xs min-h-6; }
.btn-sm { @apply h-8 px-3 text-sm min-h-8; }
.btn-md { @apply h-12 px-4 text-sm min-h-12; }
.btn-lg { @apply h-16 px-6 text-lg min-h-16; }
.btn-xl { @apply h-20 px-8 text-xl min-h-20; }

/* 输入框尺寸 */
.input-xs { @apply h-6 px-2 text-xs min-h-6; }
.input-sm { @apply h-8 px-3 text-sm min-h-8; }
.input-md { @apply h-12 px-4 text-sm min-h-12; }
.input-lg { @apply h-16 px-6 text-lg min-h-16; }
.input-xl { @apply h-20 px-8 text-xl min-h-20; }
```
