export default [
  { text: '首页', link: '/' },
  {
    ...
    items: [
      ...
      { text: '命令文档', link: '/use/command/index.html' },
      { text: '深度学习', link: '/use/in-depth/terminal-command.html' },
    ],
  },
  {
    text: '开发指南',
    items: [
      { text: '添加命令', link: '/develop/command/knowledge.html' },
      { text: '开发文档', link: '/develop/doc/api.html' },
      { text: '深入理解', link: '/develop/best-practices.html' },
    ],
  },
  {
    text: '规范',
    items: [
      { text: '命名', link: '/std/command.html' },
