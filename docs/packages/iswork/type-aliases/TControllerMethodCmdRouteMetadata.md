...
> **TControllerMethodCmdRouteMetadata** = `object`

Defined in: src/packages/iswork/src/types/controller.ts:70
...
> `optional` **options**: [`TControllerMethodCmdRouteOptions`](TControllerMethodCmdRouteOptions.md)[]
...
> `optional` **subcommand**: `TControllerMethodCmdRouteMetadata`
...
Defined in: src/packages/iswork/src/types/controller.ts:73
