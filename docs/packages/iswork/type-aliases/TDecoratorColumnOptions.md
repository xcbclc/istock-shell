...
> **TDecoratorColumnOptions** = `object`

Defined in: src/packages/iswork/src/orm/types/decorator.ts:11
...
Defined in: src/packages/iswork/src/orm/types/decorator.ts:15
