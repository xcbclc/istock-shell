...
> **TControllerMethodComponentOutput**\<`Props`\> = `object`

Defined in: src/packages/iswork/src/types/controller.ts:38
...
Defined in: src/packages/iswork/src/types/controller.ts:40
