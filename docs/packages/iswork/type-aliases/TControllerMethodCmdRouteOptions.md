...
> **TControllerMethodCmdRouteOptions** = `object`

Defined in: src/packages/iswork/src/types/controller.ts:82

## Properties

### choices?

> `optional` **choices**: (`string` \| `number` \| `boolean` \| `null`)[]
...
Defined in: src/packages/iswork/src/types/controller.ts:85
