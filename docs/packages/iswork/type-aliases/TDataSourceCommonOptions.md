...
> **TDataSourceCommonOptions** = `object`

Defined in: src/packages/iswork/src/orm/types/data-source.ts:5
...
> **entities**: [`TModelType`](TModelType.md)[]
...
> **type**: [`TDataSourceType`](TDataSourceType.md)
...
Defined in: src/packages/iswork/src/orm/types/data-source.ts:10
