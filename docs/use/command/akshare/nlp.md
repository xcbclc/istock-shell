...
`zryycl_zstp <fields> <entity> <desc> <tag> <avg> [-word [word]] [-indicator [indicator]]`
...
`zryycl_znwd`
<IStockShellDemo cmd='zryycl_znwd' :domains='[{"viewName":"akshare","name":"akshare"}]' :height='640'/>
